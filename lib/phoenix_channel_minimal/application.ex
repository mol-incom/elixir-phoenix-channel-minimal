defmodule PhoenixChannelMinimal.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: PhoenixChannelMinimal.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    PhoenixChannelMinimalWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
